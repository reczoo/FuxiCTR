...
+ :point_right: Check [the BARS benchmark website](https://openbenchmark.github.io/ctr-prediction).
...
4. [How to use h5 data as input](./tutorials/v1.1/run_model_with_h5_input.ipynb)

5. [How to make configurations?](./tutorials/v1.1/how_to_make_configurations.ipynb)

6. [How to tune the model hyper-parameters via grid search](./tutorials/v1.1/tune_model_via_grid_search.ipynb)

7. [How to use sequence features](./demo/DeepFM_with_sequence_feature.py)

8. [How to load pretrained embeddings as features](./demo/DeepFM_with_pretrained_emb.py)
