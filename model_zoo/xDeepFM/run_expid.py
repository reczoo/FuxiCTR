...
if __name__ == '__main__':
    ...
    parser.add_argument('--expid', type=str, default='xDeepFM_test', help='The experiment id to run.')
    ...
    # ✅ Overwrite feature_specs with full dict list
